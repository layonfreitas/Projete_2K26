// Conjunto único de ícones de traço (estilo "line") usado no app inteiro.
// Substitui os emojis, que mudam de aparência conforme o aparelho.
...
export default function Icon({ nome, tamanho = 20, espessura = 1.8, className = "" }) {
  return (
    <svg
      className={`ui-icone ${className}`.trim()}
      width={tamanho}
      height={tamanho}
      viewBox="0 0 24 24"
      fill="none"
